...
echo -e "$bar1"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "${rojo}#    ${verde}Bienvenido${blanco}, Gracias por utilizar MAXPLAY-VPN ${verdeR}VPN     ${rojo}# ${cierre}"
    ...
    echo -e "${rojo}#          ${blanco}dev: ${moradoL}@maxplayvpn ${blanco}- ${amarillo}MAXPLAY- ${verdeR}VPN${cierre}           ${rojo}#${cierre}"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "$bar1"
}
